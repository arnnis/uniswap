interface Resources {
  "en-US": {
    ...
    "account.recoveryPhrase.remove.mnemonic.description": "It shares the same recovery phrase as {{walletName}}. Your recovery phrase will remain stored until you delete all remaining wallets.",
    ...
    "extension.feedback.description": "Tell us how we can improve — request features, report a bug, or anything else.",
    "extension.feedback.title": "We’d love to get your feedback",
    ...
    "fiatOnRamp.button.chooseToken": "Choose a token",
    "fiatOnRamp.button.continueCheckout": "Continue to checkout",
    "fiatOnRamp.checkout.button": "Checkout",
    ...
    "fiatOnRamp.quote.others": "others",
    ...
    "home.banner.extension.confirm": "Join Beta",
    "home.banner.extension.message": "Be the first to try out the Uniswap Extension on your web browser",
    "home.banner.extension.title": "Uniswap Extension is here",
    ...
    "home.modal.getExtension.step1": "1. Visit <highlight>uniswap.org/ext</highlight> on your computer",
    "home.modal.getExtension.step2": "2. Add the Uniswap Extension on your Chrome browser",
    "home.modal.getExtension.step3": "3. Enter your username to get access",
    "home.modal.getExtension.title": "Join the Uniswap Extension Beta",
    ...
    "onboarding.backup.manual.banner": "It’s best to write this on a piece of paper and store it in a safe place or in a secure password manager.",
    ...
    "onboarding.backup.option.cloud.description": "Encrypt your recovery phrase with a secure password",
    "onboarding.backup.option.cloud.title": "{{cloudProviderName}} backup",
    "onboarding.backup.option.manual.description": "Write your recovery phrase down and store it in a safe location",
    "onboarding.backup.option.manual.title": "Manual backup",
    "onboarding.backup.subtitle": "Backups let you restore your wallet if you delete the app or lose your device",
    "onboarding.backup.title.existing": "Back up your wallet",
    "onboarding.backup.title.new": "Choose a backup method",
    ...
    "onboarding.cloud.confirm.description": "You’ll need to enter this password to recover your account. It’s not stored anywhere, so it can’t be recovered by anyone else.",
    "onboarding.cloud.confirm.title": "Confirm your backup password",
    "onboarding.cloud.createPassword.description": "You’ll need to enter this password to recover your wallet.",
    "onboarding.cloud.createPassword.title": "Create your backup password",
    ...
    "onboarding.landing.button.create": "Create a new wallet",
    ...
    "onboarding.recoveryPhrase.confirm.subtitle.combined": "Confirm your recovery phrase. Select the missing words in order.",
    "onboarding.recoveryPhrase.confirm.subtitle.default": "Select the missing words in order.",
    "onboarding.recoveryPhrase.confirm.title": "Confirm your recovery phrase",
    "onboarding.recoveryPhrase.view.subtitle": "You can check this in settings at any time.",
    "onboarding.recoveryPhrase.view.title": "Write down your recovery phrase in order",
    ...
    "qrScanner.recipient.input.placeholder": "Search ENS or address",
    "qrScanner.recipient.label.send": "Send",
    "qrScanner.recipient.results.empty": "No results found",
    "qrScanner.recipient.results.error": "The address you typed either does not exist or is spelled incorrectly.",
    ...
    "scantastic.modal.ipMismatch.description": "To scan this QR code, your phone must be connected to the same WiFi network as your computer.",
    "scantastic.modal.ipMismatch.title": "Switch your WiFi network",
    "scantastic.modal.notOnWaitlist.message": "In order to become eligible for the Uniswap Extension Beta, join the waitlist by claiming a uni.eth username",
    "scantastic.modal.notOnWaitlist.title": "You’re not on the waitlist",
    "scantastic.modal.onWaitlist.message": "We’ll notify you in the app when you become eligible to join the Uniswap Extension Beta.",
    "scantastic.modal.onWaitlist.title": "You’re still on the waitlist",
    ...
    "send.review.summary.sending": "Sending",
    "send.review.summary.to": "To",
    ...
    "send.status.fail.description": "Keep in mind that the network cost is still charged for failed transfers.",
    "send.status.failed.title": "Send failed",
    "send.status.inProgress.description": "We’ll notify you once your transaction is complete.",
    "send.status.inProgress.title": "Sending",
    "send.status.success.description": "You sent {{currencyAmount}}{{tokenName}}{{fiatValue}} to {{recipient}}.",
    "send.status.success.title": "Send successful!",
    "send.title": "Send",
    ...
    "settings.setting.backup.password.disclaimer": "Uniswap Labs does not store your password and can’t recover it, so it’s crucial you remember it.",
    ...
    "swap.button.view": "View transaction",
    "swap.button.wrap": "Wrap",
    "swap.details.action.less": "Show less",
    "swap.details.action.more": "Show more",
    ...
    "swap.form.balance": "Balance",
    "swap.form.header": "Swap",
    "swap.form.slippage": "{{slippageTolerancePercent}} slippage",
    ...
    "swap.hold.swap": "Hold to swap",
    "swap.hold.tip": "Tip: Hold to instant swap",
    "swap.hold.unwrap": "Hold to unwrap",
    "swap.hold.wrap": "Hold to wrap",
    ...
    "swap.settings.slippage.control.title": "Max slippage",
    ...
    "swap.slippage.settings.title": "Slippage settings",
    ...
    "token.safetyLevel.medium.message": "This token isn’t traded on leading U.S. centralized exchanges. Always conduct your own research before trading.",
    "token.safetyLevel.strong.header": "Warning",
    "token.safetyLevel.strong.message": "This token isn’t traded on leading U.S. centralized exchanges or frequently swapped on Uniswap. Always conduct your own research before trading.",
    ...
    "tokens.hidden.label": "Hidden ({{numHidden}})",
    ...
    "tokens.nfts.hidden.label": "Hidden ({{numHidden}})",
    ...
    "transaction.action.copyMoonPay": "Copy MoonPay transaction ID",
    "transaction.action.view": "View {{tokenSymbol}}",
    "transaction.action.viewEtherscan": "View on {{blockExplorerName}}",
    "transaction.action.viewMoonPay": "View on MoonPay",
    "transaction.amount.unlimited": "Unlimited",
    "transaction.currency.unknown": "unknown token",
    ...
    "transaction.status.confirm.canceling": "Canceling confirm",
    ...
    "transaction.status.purchase.failed": "Failed to purchase",
    ...
    "transaction.status.purchase.success": "Purchased",
    "transaction.status.purchase.successDapp": "Purchased on {{externalDappName}}",
    ...
    "transaction.status.receive.failed": "Failed to receive",
    ...
    "unitags.claim.error.ens": "To claim this username you must own the {{username}}.eth ENS",
    "unitags.claim.error.ensMismatch": "This username is not currently available.",
    ...
    "unitags.onboarding.claim.subtitle": "This is your unique name that anyone can send crypto to.",
    "unitags.onboarding.claim.title.choose": "Choose your username",
    "unitags.onboarding.claim.title.claim": "Claim your username",
    "unitags.onboarding.claimPeriod.description": "For a limited time, the username {{username}} is reserved. Import the wallet that owns {{username}}.eth ENS to claim this username or try again after the claim period.",
    "unitags.onboarding.claimPeriod.link": "Learn more about our <highlight>claim period</highlight>.",
    "unitags.onboarding.claimPeriod.title": "ENS claim period",
    ...
    "walletConnect.pending.title": "{{dappName}} wants to connect to your wallet",
    ...
    "walletConnect.permissions.title": "App permissions",
    ...
    "walletConnect.request.details.label.recipient": "To: ",
    ...
    "walletConnect.request.label.network": "Network",
    "walletConnect.request.warning.general.message": "Be careful: this message may transfer assets",
    "walletConnect.request.warning.general.transaction": "Be careful: this transaction may transfer assets",
